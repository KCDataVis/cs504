...
df = pd.read_csv(
"/Users/zackkingbackup/Documents/Grad Schools/GMU_Masters/CS 504/Project/Kaggle Data/all_stocks_5yr_pctdiff_vol.csv")

mt1 = time.time()
# use the chart pattern matching algorithm to output a forecast
# I've got a few options in here... try help(mf.match) to see
ya, pred, yeval, xvalst, xvalsp = mf.match(df=df,pattern_length=pattern_length,
...
mf.plotMatch(ya, pred, yeval, xvalst, xvalsp,title=target,xy=[50,58],savefile='Images/testing123.png')
