...
target = 'DGX'
pattern_type = 'Double Bottoms ~6 months'
image_loc='../Images'
#start_date = datetime.datetime(2015,9,14)
start_date = getdatewithfloat(df, name=target, floatyear=2015.7)
end_date = getdatewithfloat(df, name=target, floatyear=2016.24)
pattern_length = getpatternlength(df, target, start_date, end_date)
